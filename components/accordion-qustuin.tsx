  ...
  return (
    <Accordion type="single" collapsible className="w-full">
      ...
      <AccordionItem value="item-4">
        ...
        <AccordionContent>
          الحد الأدنى للتقسيط يبدأ من 1000 جنيه، ويمكن تقسيم المبلغ على شهرين
          فقط.
        </AccordionContent>
      </AccordionItem>
        ...
        <AccordionContent>
          ...
          <ul className="list-disc pl-5 mt-2">
            ...
            <li>
              ...
              <ul className="list-disc pl-5 mt-2">
                <li>
                  نقوم بإرسال صور واضحة لك لحالة المنتج عبر الواتساب لتتأكد من
                  حالته.
                </li>
                <li>
                  أو الافضل يمكنك زيارة المخزن لدينا لمعاينة المنتج بنفسك خلال
                  مدة لا تزيد عن 10 أيام من تاريخ الاتفاق.او بعدها لا يمكن
                  استرجاع المنتج
                </li>
                <li>
